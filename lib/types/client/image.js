 ...
 */
export async function applyImageFile(file, maxBytes = IMAGE_MAX_BYTES) {
 ...
 */
export function downscaleToDataUrl(image, maxEdge = IMAGE_MAX_EDGE, quality = IMAGE_QUALITY) {
